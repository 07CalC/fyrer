...
<CardGroup cols={2}>
  <Card title="Packages" icon="folder" href="/docs/configuration/packages">
    Configure package names, roots, and env files
  </Card>
  <Card title="Tasks" icon="list-check" href="/docs/configuration/tasks">
    Configure commands, caching, dependencies, and more
  </Card>
  <Card title="Environment" icon="key" href="/docs/configuration/environment">
