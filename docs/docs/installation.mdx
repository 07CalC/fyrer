---
title: "Installing fyrer"
sidebarTitle: "Installation"
description: "Install fyrer as a single self-contained binary — via install script, cargo install from crates.io, or build from source."
---
