...
fyrer is distributed as a single self-contained binary compiled from Rust — there are no runtimes, daemons, or additional dependencies to manage. There are five ways to get it onto your machine. Pick whichever suits your platform and workflow. Prebuilt binaries are published to [GitHub Releases](https://github.com/07calc/fyrer/releases) for Linux, macOS, and Windows (x64 \+ arm64); `cargo install` pulls from crates.io; and the npm package wraps the same verified binary.
