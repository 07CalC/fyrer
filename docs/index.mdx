...
Welcome to **fyrer** — a declarative, language-agnostic task orchestrator built for monorepos. Define your packages and tasks in a `fyrer.yml` config file at your repo root, and fyrer resolves the dependency graph, runs tasks in streaming order as soon as dependencies finish, and skips unchanged work using a content-addressed cache. Whether you're coordinating Rust services, TypeScript frontends, or Python tooling, fyrer keeps your build pipeline fast and your dev loop tight.
...
<CardGroup cols={2}>
  <Card title="Concurrent Execution" icon="bolt" href="/concepts/how-it-works">
    Runs tasks in streaming DAG order, maximising throughput across your monorepo.
  </Card>
